...
- A set t-scores will be generated based on gendered and non-gendered
  norms. Please feel free to include children who are trans or
  non-binary in your dataset and code gender as appropriate for your
  study. Non-gendered t-scores will be generated for all individuals. To
  generate gendered t-scores be sure to code gender as 1 = Male and 2 =
  Female.
...
2.  Be sure the following columns are present in the spreadsheet and
    ...
    | gender | The child’s gender. Please feel free to include children who are trans or non-binary in your dataset and code gender as appropriate for your study. Non-gendered t-scores will be generated for all individuals. To generate gendered t-scores be sure to code gender as 1 = Male and 2 = Female. | 1 = Male, 2 = Female |
