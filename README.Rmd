...
2.  Be sure the following columns are present in the spreadsheet and
    ...
    +---------------+---------------+---------------+
    | swan6         | 6\. Engage in | -3 (Far       |
    |               | tasks that    | Below) to 3   |
    |               | require       | (Far Above)   |
    |               | sustained     |               |
    |               | mental effort |               |
    +---------------+---------------+---------------+
    ...
    |               | quietly (keep | Below) to 3   |
    |               | noise level   | (Far Above)   |
    |               | reasonable)   |               |
    +---------------+---------------+---------------+
    | swan14        | 14\. Settle   | -3 (Far       |
    |               | down and rest | Below) to 3   |
    |               | (control      | (Far Above)   |
    |               | constant      |               |
    |               | activity)     |               |
    +---------------+---------------+---------------+
    | swan15        | 15\. Modulate | -3 (Far       |
    |               | verbal        | Below) to 3   |
    |               | activity      | (Far Above)   |
    |               | (control      |               |
    |               | excess        |               |
